                                ...
                                <div class="mt-4 mb-4 ms-3 me-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <x-form.input name="name"  type="text" id="name" label=" الاسم الرباعي للموظف " required="required" placeholder=" ادخل الاسم الرباعي " />
                                        </div>

                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <x-form.input name="email"  type="email" id="email" label="  البريد الالكتروني " required="required" placeholder=" ادخل  البريد الالكتروني   " />
                                        </div>


                                        {{-- birth-place --}}
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <x-form.input name="phone"  type="text" id="phone" required="required" label=" رقم هاتف الموظف " placeholder="ادخل رقم هاتف الموظف"/>
                                        </div>
                                        ...
                                        {{-- image --}}
                                        <div class="col-12 col-md-6  mb-4" id="medical_report_health">
