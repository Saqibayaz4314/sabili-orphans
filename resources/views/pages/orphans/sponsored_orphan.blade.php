            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    @forelse ($orphans as $orphan)
                        ...
                        <tr>
                            ...
                            <td class="d-flex flex-wrap gap-1">
                                ...
                                <a href="{{route('orphans.sponsorship.index' , ['orphan_code' => $orphan->orphan_code])}}" class="text-decoration-none mb-1 btn btn-outline-success"> تسليم الكفالة </a>
                    ...
                    @empty
                        ...
                        <td colspan="8" class="fs-4 text-center" style="color: var(--primary-color)">  لا يوجد ايتام مكفولين  مسجلين في النظام </td>
