<x-main-layout title="مؤسسة سبيلي الخيرية">
    ...
    <section class="mt-1">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            ...
            <a href="" class="submit-btn text-decoration-none rounded" style="padding-right:60px;padding-left:60px"> إنشاء استعلام </a>
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    @empty
                        ...
                        <td colspan="8" class="fs-4 text-center" style="color: var(--primary-color)">  لا يوجد ايتام قيد الانتظار مسجلين في النظام </td>
